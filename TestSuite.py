...
"""
Author: NTM - 4/22/2025
Test case:
    INSERT:      0 ->  59:  60
    ASSIGN:     60 -> 175: 116
    BEGIN+END: 176 -> 276: 101
    LOOKUP:    277 -> 332:  56
    PRINT:     333 -> 359:  27
    RPRINT:    360 -> 386:  27
    OTHER:     387 -> 399:  13
...
class TestSymbolTable(unittest.TestCase):
    ...
    def test_23(self):
        input = ["INSERT _ number"]
        expected = ["Invalid: INSERT _ number"]
